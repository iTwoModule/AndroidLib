...
public class NineGridLayout extends ViewGroup {
    ...
    private List<? extends ImageResource> mImageInfo;
    ...
    public NineGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        gridSpacing = (int) a.getDimension(R.styleable.NineGridLayout_ngv_gridSpacing, gridSpacing);
        singleImageSize = a.getDimensionPixelSize(R.styleable.NineGridLayout_ngv_singleImageSize, singleImageSize);
        singleImageRatio = a.getFloat(R.styleable.NineGridLayout_ngv_singleImageRatio, singleImageRatio);
        maxImageSize = a.getInt(R.styleable.NineGridLayout_ngv_maxSize, maxImageSize);
        mode = a.getInt(R.styleable.NineGridLayout_ngv_mode, mode);
        a.recycle();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            if (mImageLoader != null) {
                mImageLoader.displayImage(getContext(), mImageInfo.get(i).thumbnailUrl(),childrenView);
            }
        }
    }

    /** 设置适配器 */
    public <ImageInfo extends ImageResource> void setAdapter(@NonNull NineGridViewAdapter<ImageInfo> adapter) {
        mAdapter = adapter;
        ...
        // @author wong.taian  TIME: 17/10/25  17:54  默认3列
//        columnCount = 3;
        // @author wong.taian  TIME: 17/10/25  18:00  4张图片时2列，其他大于3张时3列，小于3张一张一列
        columnCount = imageCount == 4 ? 2 :
                imageCount > 3 ? 3 :
                        imageCount == 0 ? 3 :
                                imageCount;
        ...
        if (position < imageViews.size()) {
            ...
            imageView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mAdapter.onImageItemClick(getContext(), NineGridLayout.this, position, mAdapter.getImageInfo());
                }
            });
    ...
    public static void setImageLoader(ImageLoader imageLoader) {
        NineGridLayout.mImageLoader = imageLoader;
    }
