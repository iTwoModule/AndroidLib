...
public class ShimmerLayout extends FrameLayout {
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, Color.parseColor("#A2878787"));
            autoStart = a.getBoolean(R.styleable.ShimmerLayout_shimmer_auto_start, true);
            maskWidth = a.getFloat(R.styleable.ShimmerLayout_shimmer_mask_width, 0.1F);
